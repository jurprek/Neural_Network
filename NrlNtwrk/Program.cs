...
partial class NeuralNetwork
{
    ...
    static void Main(string[] args)
    {
        ...
        double[,] primjer = {
            { 0,0.324208011232084,0.377540668798145,0.645656306225795,0,1 },
            { 1,0.445117768565854,0.377540668798145,0.750260105595118,0,1 },
            { 0,0.268941421369995,0.377540668798145,0.574442516811659,0,0 },
            { 1,0.381023088331113,0.377540668798145,0.682799386093413,0,1 },
            { 0,0.376376229771452,0.377540668798145,0.796841069544177,1,0 },
            { 0,0.781640136615092,0.377540668798145,0.637993670660984,1,0 },
        ...
        for (int red = 0; red < primjer.GetLength(0); red++)
        {
            ...
            Console.WriteLine("-------------1 1 0 1 0 0 1");
        }
